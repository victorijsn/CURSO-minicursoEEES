...
# A base de dados
## Arrumando a base de dados
Comando para renomeando as variáveis.
```{r}
...
# A base de dados
## Arrumando a base de dados
transformar as informações contidas nas linhas em parte das colunas. Como são duas informações de linha *variavel* e *unidade_territorial* e duas informações de coluna *indica_bf* e *indice_bf_sa*, serão as duas colunas se transformarão em oito.
```{r}
dados_tidy <- dados_tidy %>% 
